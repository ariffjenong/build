...
system () {
  ...
  ls -lh
  time com selinux 1
  time rclone copy selinux.tar.* znxtproject:rom/$ROM_PROJECT/system/etc -P
}
...
product () {
  ...
  ls -lh
  time com selinux 1
  time rclone copy selinux.tar.* znxtproject:rom/$ROM_PROJECT/system/product/etc -P
}
...
system-ext () {
  ...
  ls -lh
  time com selinux 1
  time rclone copy selinux.tar.* znxtproject:rom/$ROM_PROJECT/system/system-ext/etc -P
}
...
vendor () {
  ...
  ls -lh
  time com selinux 1
  time rclone copy selinux.tar.* znxtproject:rom/$ROM_PROJECT/system/vendor/etc -P
}

root () {
  cd /cirrus/rom/out/target/product/maple_dsds/recovery/root
  ls -lh
  time rclone copy sepolicy znxtproject:rom/$ROM_PROJECT/system/ -P
}
